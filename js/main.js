...
const supported_coins = ["bitcoin", "ethereum", "cardano", "matic-network", "curve-dao-token", "terra-luna", "anchor-protocol", "mirror-protocol", "astroport", "mars-protocol", "kujira", "cosmos", "monero", "solana", "avalanche-2", "chainlink", "fantom", "olympus", "the-sandbox"];
