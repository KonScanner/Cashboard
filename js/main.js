...
const supported_coins = ["bitcoin", "ethereum", "cardano", "matic-network", "curve-dao-token", "terra-luna", "anchor-protocol", "mirror-protocol", "astroport", "mars-protocol", "kujira", "cosmos", "monero", "solana", "avalanche-2", "chainlink", "polkadot", "olympus", "the-sandbox"];
const supported_stables = ["tether", "usd-coin", "binance-usd", "terrausd", "dai", "frax", "true-usd", "paxos-standard", "fei-usd", "liquity-usd", "neutrino", "mimatic", "alchemix-usd", "origin-dollar", "magic-internet-money", "tether-eurt", "seur", "stasis-eurs", "tether-gold"];
